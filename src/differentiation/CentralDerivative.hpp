...
namespace metII {
    ...
    class CentralDerivative : public Derivative {
        ...
        public:
            ...
            CentralDerivative (std::function<double(double)> _f, std::size_t _derivative_order = 1, std::size_t _error_order = 2, double _epsilon = 1.0e-6, double _h_divider = 2.0, double _initial_h = 0.1, bool _check_for_invalid_iterations = false);
